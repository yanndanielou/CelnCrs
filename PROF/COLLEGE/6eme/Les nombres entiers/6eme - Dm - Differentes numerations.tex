...
\textit{Lire un nombre maya :}				\hspace*{7cm}			\textit{Écrire un nombre en maya :}\\
 \includegraphics[scale=0.6]{maya7.eps} \hspace*{2cm}	  \includegraphics[scale=0.8]{maya11.eps} \\
...
\includegraphics[scale=0.6]{maya8.eps}  \hspace*{4.5cm}\includegraphics[scale=0.6]{maya9.eps}  \hspace*{4.5cm} \includegraphics[scale=0.6]{maya10.eps} \\
...
$138 = 1 \times 100 + 3 \times 10 + 8$ \hspace*{0.3cm} Il s'écrivait donc ainsi : \includegraphics[scale=0.8]{chinoise2.eps}\\
...
Il s'écrivait donc ainsi : \hspace*{0.3cm} \includegraphics[scale=0.8]{chinoise3.eps}\\
