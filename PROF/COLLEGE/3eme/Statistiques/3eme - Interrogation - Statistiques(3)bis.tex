...
\q Quel est le pourcentage de coureurs ayant effectués strictement moins de 330 tours de circuit ?\\
\reponse[3]\\
...
\hline 
\textbf{Temps t} (en s) & $8,3 \leq t < 8,7$ & $8,7 \leq t < 9,1$ & $9,1 \leq t < 9,5$& $9,5 \leq t < 9,9$ & $9,9 \leq t < 10,4$ \\ 
\hline 
...
\q   Quel est  le  pourcentage  d'élèves  ayant  couru le 60 m 9,5 secondes ou plus?\\
\reponse[2]\\
