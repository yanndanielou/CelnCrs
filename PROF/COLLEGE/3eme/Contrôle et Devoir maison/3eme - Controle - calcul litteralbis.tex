...
$H= 3x(7x-5)$ \hspace*{1.5cm} $S = (8x-1)(2+9x)$ 

\vspace*{0.5cm}

\exo{4} Factoriser les expressions suivantes :\\

$A = (x + 5) (6x - 2) +(x + 5) (9x - 1)$	\hspace*{1.5cm}	$B = (2x+1)^{2}-(5-13x)(2x+1)$ \\


\vspace*{0.5cm}

\exo{4} On donne l'expression suivante : $C=(3x-7)(1-2x)-(1-2x)(8-5x)$\\
...
\initq \q Le nombre de départ est 4. Quel est le résultat final pour chacun des deux programmes ? Que constatez-vous ? \\
