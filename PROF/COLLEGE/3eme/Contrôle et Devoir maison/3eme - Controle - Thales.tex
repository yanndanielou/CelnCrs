...
\hline 
\textbf{FIGURE 1} & \includegraphics[scale=1]{qcm1.eps} \textbf{Quelle est la bonne égalité ?}  & $\dfrac{AD}{AC}=\dfrac{AB}{DE}=\dfrac{BE}{BC}$ & $\dfrac{CD}{AC}=\dfrac{CE}{CB}=\dfrac{DE}{AB}$  & $\dfrac{CD}{DA}=\dfrac{CE}{EB}=\dfrac{DE}{AB}$  \\ 
\hline 
\textbf{FIGURE 2} &  \includegraphics[scale=1]{qcm2.eps} \textbf{Quelle est la bonne égalité ?} & $\dfrac{AC}{AD}=\dfrac{BC}{BE}=\dfrac{AB}{DE}$ & $\dfrac{EC}{CB}=\dfrac{DC}{CA}=\dfrac{AB}{DE}$ & $\dfrac{AC}{CD}=\dfrac{BC}{CE}=\dfrac{AB}{DE}$\\ 
\hline 
\textbf{FIGURE 3} & \includegraphics[scale=1.1]{qcm3.eps} \textbf{Les droites (BE) et (FC) sont-elles parallèles ?} & Non & Oui & On ne peut pas savoir \\ 
\hline 
\end{tabular} 
\end{flushleft}
