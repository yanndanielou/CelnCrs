...
\exo{3} Soit $f$ la fonction définie par $f(x) = -3x^{2}+7x-10$.\\
...
\q Quel est l'antécédent de - 10 par la fonction $f$ ?\\
\reponse[1]\\
...
\q Quelle est l'image de - 3 par la fonction f ?\\
\reponse[1]\\
...
$f(4) = . . .$ \hspace*{0.3cm} $f(. . .) = 3$ \hspace*{0.3cm} $f(-6) = . . .$ \hspace*{0.3cm} $f(. . .) = -3$  \\
