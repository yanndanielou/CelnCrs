...
\qa Quelle est l'image de la pièce 1 par la symétrie d'axe (CD) ?\\

\qa Quelle est l'image de la pièce 1 par la symétrie de centre A ?\\

\qa Dans la translation qui transforme A en E, quelle est l'image de la pièce 10 ?\\

\qa Dans la rotation de centre B et d'angle 90 degré, dans le sens des aiguilles d'une montre, quelle est l'image de la pièce 8?\\
