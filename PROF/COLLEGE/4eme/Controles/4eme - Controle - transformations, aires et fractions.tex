...
\q Écrire la formule pour calculer l'aire d'un triangle et d'un disque.\\

\q Calculer l'aire d'un disque de rayon 20 cm.\\
...
\includegraphics[scale=0.95]{pyramide1.eps} 
...
Il pose $\dfrac{4}{15}$ du papier peint le premier jour, $\dfrac{2}{5}$ le deuxième jour et $\dfrac{1}{6}$ le troisième jour.\\
