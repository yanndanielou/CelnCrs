...
\q Compléter le tableau ci-dessous :\\

\begin{tabular}{|c|c|c|c|c|c|c|c|}
\hline 
\textbf{Nombre de tours de circuit} & \textbf{310} & \textbf{320} & \textbf{330} & \textbf{340} & \textbf{350} & \textbf{360}& \textbf{Total} \\ 
\hline 
\textbf{Effectif} &  &  &  &  &  & & \\ 
\hline 
\end{tabular} 
...
\q Quel est le pourcentage de coureurs ayant effectués strictement moins de 340 tours de circuit ?\\
\reponse[3]\\
...
\hline 
\textbf{Temps t} (en s) & $8,5 \leq t < 8,9$ & $8,9 \leq t < 9,3$ & $9,3 \leq t < 9,7$& $9,7 \leq t < 10,1$ & $10,1 \leq t < 10,5$ \\ 
\hline 
\textbf{Centre de la classe} &  &  &  &  &  \\ 
\hline 
...
\q Compléter le tableau ci-dessus. (\textit{ Les fréquences seront données en pourcentage arrondies au dixième près.})\\

\q   Quel est  le  pourcentage  d'élèves  ayant  couru le 60 m 9,7 secondes ou plus?\\
\reponse[2]\\

\q Quelle est la performance moyenne d'un garçon de 14 ans, sur l'épreuve du 60 m, dans ce collège ?\\
\reponse[4]\\
...
\item \underline{Condition 2 }: Au moins 60 $\%$ des pièces du lot ont un diamètre \textit{d} compris entre 54,94 et 55,06.\\
