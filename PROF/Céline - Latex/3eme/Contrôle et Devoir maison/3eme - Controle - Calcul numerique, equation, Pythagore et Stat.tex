...
\hline 
\textbf{1} & L'écriture décimale du nombre $5,3 \times 10^{5}$ est : & 530 000 & 5,300 000 & 5 300 000 \\ 
\hline 
...
\hline 
\textbf{5 }& On donne le triangle suivant :\includegraphics[scale=0.85]{qcmreciproque.eps}  & Le triangle ABC est rectangle en C & Le triangle ABC n'est pas rectangle & On ne peut pas savoir \\ 
\hline 
\end{tabular} 
