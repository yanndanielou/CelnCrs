...
\exo{3} Calculer la longueur JM dans le triangle JFM rectangle en F.

\begin{center}
\includegraphics[scale=1.35]{exo22.eps} 
\end{center}



\exo{3} Sur la figure ci-dessous, les doites (DE) et (AC) sont parallèles.\\
