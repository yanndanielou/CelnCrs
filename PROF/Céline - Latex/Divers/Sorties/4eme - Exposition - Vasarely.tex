...
\begin{center}
\textbf{\ding{47} LES AVANTS-GARDES EN HÉRITAGE}
\end{center}

\q En combien de partie, le parcours de l'exposition est-il divisé ? Citez en une et donnez la référence de l'\oe{uvres} que vous préférez dans cette partie.\\
\reponse[2]\\
...
\q Cette \oe{uvre} pourrait s'appeler : \textbf{"La géométrie en équilibre"}. De quelle \oe{uvre} s'agit-il ?\\
\reponse[1]\\
...
\q Observer l'\oe{uvre} suivante : \textbf{"Dobkö"} \textit{1957-1959, Collection particulière}. 	\\
...
\q Observer l'\oe{uvre} suivante : \textbf{"Naissance"} \textit{1958, Collection particulière, Suisse}.
...
\q Après l'\oe{uvre}, \textbf{"T.M"} \textit{1958, Collection particulière},  un autre élément entre en jeu dans le travail de l'artiste, lequel ?\\
\reponse[2]\\
...
\q Citez quelques différences et points communs entre ces deux \oe{uvres} :\\
\hspace*{4.7cm}	- \textbf{"Pyr Fekete"} \textit{1963, Collection particulière}\\
\hspace*{2cm} et	
\hspace*{2cm}	- \textbf{"Salgo Négatif"} \textit{1967, édition 2/10}\\
	\reponse[5]\\
	
\q Placez vous à 6 pas de l'\oe{uvre} \textbf{"V-Boglar"} \textit{1966, Musée National d'art moderne, Centre Pompidou, Paris, don de l'artiste en 1977}\\
	Avancez vers l'\oe{uvre} en fixant du regard le centre du tableau.\\
	Que remarquez vous ?\\
	\reponse[3]\\
Vous pouvez faire le même exercice avec l'\oe{uvre} \textbf{"Alom"} \textit{1966 Musée National d'art moderne, Centre Pompidou, Paris, don de l'artiste en 1977}.\\
...
\q Dans cette nouvelle salle, choisissez une \oe{uvre} sur la table centrale et représentez la rapidement.\\
\vspace*{-0.75cm}
