...
\begin{document}
\pagestyle{empty}
\titre{Contrôle 3 : Etude des fonctions affines }{Nom :}{Prénom :}{\textbf{2nd 8}}{Sujet C}
...
\initqa \qa $f(x)=3x^3-5$  \qa $g(x)=-x+\dfrac{1}{2}$ \qa $k(x)=\dfrac{-2}{4+3x}$ \qa $h(x)=\dfrac{9-x}{7}$\\
...
\initqa \qa $f(x)=-\sqrt{3}x+13$ \hspace*{0.5cm}\qa $g(x)=15-1,5x$\hspace*{0.5cm} \qa $h(x)=-11(5-x)$\\
...
\initqa \qa $f(x)=-5x+22$ \hspace*{0.75cm}  \qa $h(x)=3,5x+17$  \hspace*{0.75cm} \qa $h(x)=\dfrac{3-x}{9}$\\

\vspace*{0.75cm}

\exo{7} 
Soient $f$ et $g$ deux fonctions affines définies sur $\R$ par $f(x)=2,5x+8$ et $g(x)=-4x-5$\\
...
\q \initqa \qa Résoudre graphiquement $f(x)< 0$ sur $\R$ .\\
