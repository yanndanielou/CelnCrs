...
\begin{document}
\pagestyle{empty}
\titre{Contrôle 3 : Etude des fonctions affines }{Nom :}{Prénom :}{\textbf{2nd 8}}{Sujet A}
...
\initqa \qa $f(x)=-2,5x-3$ \qa $g(x)=x^2+3x$ \qa $h(x)=\dfrac{5-x}{3}$ \qa $k(x)=\dfrac{-5}{3+2x}$\\
...
\initqa \qa $f(x)=5-6x$ \hspace*{0.5cm}\qa $g(x)=5,5x+11$\hspace*{0.5cm} \qa $h(x)=-9(1-x)$\\
...
\initqa \qa $f(x)=1,5x+4,5$ \hspace*{0.75cm}  \qa $h(x)=-2x+1$  \hspace*{0.75cm} \qa $h(x)=\dfrac{7-2x}{3}$\\
