...
\initq \q Soient  A(1 ; 9) et B(2 ; 6) deux points du plan muni d'un repère orthonormé.\\
Calculer les coordonnées du point M milieu de [AB].\\

\q Soient  A(2 ; 8) et B(1 ; 5) deux points du plan muni d'un repère orthonormé.\\
Calculer la distance AB.\\

\q Soient  A(3 ; -2), B(-3 ; 1) et C(6 ; 4) trois points du plan muni d'un repère orthonormé.\\
...
\includegraphics[scale=1.7]{grillecontrole.eps} 
...
On considère les points A(1 ; 4), B(-2 ; 1), C(4 ; 7), D(-1 ; 6), E(2 ; 3) et F(3 ; 2).\\
...
\exo{4}
On considère les points A(-4 ; -2), B(-2 ; 2), C(2 ; 2).\\
