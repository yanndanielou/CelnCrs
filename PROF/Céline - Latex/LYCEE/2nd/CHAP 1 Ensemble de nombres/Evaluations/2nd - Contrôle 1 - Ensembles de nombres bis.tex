...
\hspace*{0.5cm}$\mathbb{Z}$ . . . . $\mathbb{D}$\hspace*{0.35cm}; \hspace*{0.35cm}  $\dfrac{7}{16}$ . . . . $\mathbb{D}$ \hspace*{0.35cm}; \hspace*{0.35cm} $\dfrac{8}{13}$ . . . . $\mathbb{Q}$ \hspace*{0.35cm}; \hspace*{0.35cm} $\sqrt{16}+\sqrt{9}$ . . . . $\mathbb{N}$ \\

\hspace*{0.5cm}$\{-1 ; 0;2;5\}$ . . . . $\Z^*$ \hspace*{0.35cm}; \hspace*{0.35cm}  $\{\dfrac{15}{3};\sqrt{36}\}$ . . . . $\N$ \hspace*{0.35cm}; \hspace*{0.35cm} $\pi$ . . . . $]3,14;3,15[$ \hspace*{0.35cm}; \hspace*{0.35cm} $\mathbb{N}$ . . . . $\mathbb{Q}$ \\
