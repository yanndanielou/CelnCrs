...
\color{purple}
On sait que la suite $(u_n)$ est une suite arithmétique de raison $r=200$.\\
 Or, $r>0$ donc d'après la propriété vue en cours la suite $(u_n)$ est croissante.\\
...
\color{purple}
On sait que la suite $(v_n)$ est une suite géométrique de raison $q=0,5$.\\
 Or, $0<q<1$ par conséquent la suite $(q^n)$ est une suite décroissante.\\
Seulement $v_0$ étant négatif, la suite $(v_n)$ varie dans le sens contraire de la suite $(q^n)$.\\
...
\color{purple}
Exprimons $w_{n+1}-w_n$:\\

$w_{n+1}-w_n= 3+\dfrac{2}{n+1}-\left(3+\dfrac{2}{n}\right)$\\

$w_{n+1}-w_n= 3+\dfrac{2}{n+1}-3-\dfrac{2}{n}$\\

$w_{n+1}-w_n= \dfrac{2}{n+1}-\dfrac{2}{n}$ \hspace*{0.5cm}\textit{(mettre au même dénominateur)}\\

$w_{n+1}-w_n= \dfrac{2\times n}{(n+1)n}-\dfrac{2\times(n+1)}{n(n+1)}$\\

 $w_{n+1}-w_n= \dfrac{2\times n -2\times(n+1)}{(n+1)n}$\\
 
$w_{n+1}-w_n= \dfrac{2n -2n-1}{(n+1)n}$\\

$w_{n+1}-w_n= \dfrac{-1}{(n+1)n}$\\

$\forall n \in \N^*$, on a $n(n+1)>0$ et $-1<0$. Donc $w_{n+1}-w_n <0$\\
