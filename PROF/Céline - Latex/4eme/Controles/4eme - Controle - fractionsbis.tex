...
\exo{8} Calculer les expressions suivantes et donner la réponse \textbf{sous forme d'une fraction irréductible.
}
\bmul{3}

$B = \dfrac{-23}{8} - \dfrac{11}{8}+\dfrac{7}{8}$\\

$B = \dfrac{4}{5} - \dfrac{7}{12}+\dfrac{2}{15}$\\


\columnbreak

$N = \dfrac{2}{3} - \dfrac{4}{9}$\\
...
$ U = \dfrac{\dfrac{2}{3}}{\dfrac{10}{18}}$\\
\emul

\vspace*{0.75cm}


\exo{4} Calculer les expressions suivantes et donner la réponse \textbf{sous forme d'une fraction irréductible.}
...
$S = \dfrac{\dfrac{2}{5}-\dfrac{5}{2}}{\dfrac{5}{8}-\dfrac{13}{32}}$ \\
...
Le premier jour, il parcourt $\dfrac{2}{5}$ du trajet. Le deuxième jour, il parcourt $\dfrac{3}{10}$ du trajet.\\

Le troisième jour, il parcourt $\dfrac{24}{100}$ du trajet. Le quatrième jour, il parcourt ce qu'il reste.\\

\textbf{
\q Quelle est la fraction de la distance parcourue le dernier jour?}\\

\textbf{\q Combien de kilomètres lui reste-il a parcourir le dernier jour ?\\}

\vspace*{0.75cm}

\exo{2}
Kenza a vendu les $\dfrac{4}{7}$ de sa collection de cartes Yu-Gi-Ho. \\
