...
\qa 19 $\%$ des visiteurs étaient des touristes étrangers. Combien de touristes étrangers ont visité ce musée ?\\
\reponse[3]\\

\qa 80 $\%$ des  touristes étrangers étaient américains. Combien de touristes américains ont visité ce musée ?\\
\reponse[3]\\

\qa 8 316 visiteurs ont bénéficié d'un tarif réduit. Quel pourcentage du total des entrées payantes cela représente-t-il ?\\
\reponse[3]\\

\exo{3}  Dans le jardin de Céleste, il y a deux volière.\\
Dans l'une, il y a 50 oiseaux dont 23 $\%$ sont des hirondelles.\\
Dans l'autre, il y a 60 oiseaux dont 34 $\%$  sont des hirondelles.\\
...
\initqa \qa Un scooter coûte 945 euros. Son prix augmente de 5 $\%$.\\
Quel est le nouveau prix ?\\
\reponse[5]\\

\qa Un pantalon était vendu 90 euros.
Le commerçant fait une remise de 15 $\%$.\\
Quel est le nouveau prix du pantalon après la remise ?\\
\reponse[5]\\


\qa Gilles profite d'une promotion pour un voyage en Egypte : 625 euros au lieu de 800 euros.\\
