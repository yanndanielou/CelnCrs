...
\q Quelle est la fréquence en pourcentage du nombre d'habitants qui sont dans la tranche d'âge de 0 à 20 ans ?  \\

\q Compléter la ligne des fréquences en pourcentage. (sans justification)\\


\q Quelle est la fréquence en pourcentage du nombre d'habitants ayant au plus 40 ans \textit{(40 ans exclu)} ? \\
