...
\exo{1} Questions de cours  : Quel est le signe d'un produit de 95 facteurs non nuls dont 52 sont positifs ? (\textbf{Justifier votre réponse})\\
\reponse[4]\\
...
$W= -1 \times (-2) \times 2,5 \times (-9) \times 4 \times (-0,5) $\\
\reponse[6]\\
