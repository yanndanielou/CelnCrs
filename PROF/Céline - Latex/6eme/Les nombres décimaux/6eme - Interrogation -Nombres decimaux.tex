...
\begin{document}
\pagestyle{empty}
\titre{Interrogation: Les nombres décimaux}{Nom :}{Prénom :}{Classe}{Date}
...
\exo{1} Le nombre 11,547 est-il un nombre décimal ? Expliquer votre réponse en vous aidant de la définition vue en cours.\\
\reponse[4]\\
...
\exo{1.5} On considère le nombre 4 091,807.\\
...
\q Proposer 3 écritures différentes du nombre 57,231.\\
\reponse[4]\\
