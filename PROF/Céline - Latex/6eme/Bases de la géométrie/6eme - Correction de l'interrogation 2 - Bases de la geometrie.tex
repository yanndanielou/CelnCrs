...
\includegraphics[scale=1.2]{correxo3.eps} \\

\exo{1,5}\\

\includegraphics[scale=1.2]{correxo4.eps} \\

\exo{2} Compléter les expressions suivantes avec les symboles "$\in$" ou "$\notin$"\\

\bmul{2}

\includegraphics[scale=1.5]{correxo5.eps} 
