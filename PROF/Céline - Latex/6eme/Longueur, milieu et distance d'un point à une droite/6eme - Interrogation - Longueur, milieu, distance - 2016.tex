...
\q Dans quels cas la droite (d) est-elle la médiatrice du segment [AB]? Justifier votre réponse réponse.
...
\initq \noindent \q  Tracer un segment [AB] de longueur 9,4 cm.\\
\q Tracer la médiatrice (d) du segment [AB].\\
\q Placer ensuite un point M sur (d) tel que AM = 5 cm.\\
...
\q  Déterminer la longueur BM sans utiliser d'instrument de mesure. Expliquer.\\
\reponse[5]\\
