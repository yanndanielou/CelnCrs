...
\hspace*{1cm} $\dfrac{3}{8}$ \hspace*{2.5cm} $\dfrac{11}{20}$ \hspace*{3cm} $\dfrac{1}{5}$\\
...
\initqa \qa $\dfrac{35}{42}=\dfrac{...}{6}$ \hspace*{1cm}  \qa $\dfrac{25}{60}$   \hspace*{1cm}     \qa $\dfrac{80}{100}$\\
