...
\exo{2} Trouver le bon nombre.\\

Je suis un nombre décimal à 5 chiffres.\\
 Mon nombre de dixièmes est 243.\\
 Mon chiffres des centièmes est la somme de celui des unités et de celui des dixièmes.\\
 Mon chiffre des millièmes est la différence de celui des unités et de celui des dizaines.\\
...
\exo{4}\includegraphics[scale=0.4]{trefle.eps}  \initq \q Quelles sont les abscisses des points F, I et H ? Écrire vos réponses sous chacun des points correspondants. \\
...
\exo{2} Calculer en ligne astucieusement en détaillant les étapes de vos calculs.\\
