...
\exo{5} \includegraphics[scale=0.4]{trefle.eps} COURS
...
\emul
  ...
  \exo{2}
  Lorsque l'on effectue la division euclidienne  d'un nombre par 13, le quotient est 8 et le reste est 6.\\
...
\exo{5}Sur votre copie double.\\
\initq

\q Citer le critère de divisibilité par 9.\\


\q Parmi les nombres suivants : \hspace*{0.25cm} 14 \hspace*{0.25cm}; \hspace*{0.25cm} 233 \hspace*{0.25cm} ; \hspace*{0.25cm} 2115 \hspace*{0.25cm} ;\hspace*{0.25cm} 2523 \hspace*{0.25cm}; \hspace*{0.25cm} 210  \hspace*{0.25cm} ; \hspace*{0.25cm} 468 \hspace*{0.25cm} ;\hspace*{0.25cm} 57\\
...
\vspace*{0.5cm}
\exo{3} Pour le C.D.I. du collège, la documentaliste reçoit 370 livres qu'elle doit ranger sur des étagères. Elle ne peut transporter que 13 livres à la fois. \\
...
\exo{2}
A la fête foraine, le tour de manège coûte 5 euros. Antoine a 32 euros.\\

\initq \q Combien de tours de manège  peut-il faire ? \textit{(Justifier votre réponse.)}\\
  \\

\q Combien d'euros lui manque-t-il pour pouvoir effectuer un tour supplémentaire ? \textit{(Justifier votre réponse.)}\\
  \\
