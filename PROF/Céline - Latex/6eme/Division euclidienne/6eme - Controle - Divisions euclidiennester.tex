...
\exo{5} Poser et effectuer les divisions euclidiennes sur votre copie. \\
Pour chaque division ci-dessous, \textbf{écrire l'égalité} vue dans le cours.\\
\includegraphics[scale=0.8]{acompleter1.eps} \hspace*{2.75cm} \includegraphics[scale=0.8]{acompleter2.eps} \\

\begin{center}
 \includegraphics[scale=0.8]{acompleter3.eps}
\end{center}
