...
\begin{document}
\pagestyle{empty}
\titre{Exercices de révisions sur les fractions }{Nom :}{Prénom :}{Classe}{Date}



\vspace*{0.2cm}
\textit{Si vous avez besoin, vous pouvez vous aider de votre cours, mais essayez de faire seul ces exercices de révisions.}\\

\textit{Je rappelle que la rédaction d'une réponse à un problème doit être composée au minimum d'un calcul et d'une phrase réponse.}\\
