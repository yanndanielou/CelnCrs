...
\bi
\item Le volume d'une boule de rayon $r$ est défini par la formule : $V = \dfrac{4}{3}\pi r^{3}$\\

\textbf{Exemple :} Le volume d'une boule de rayon 5cm est :
\bmul{2}
$V = \dfrac{4}{3}\pi r^{3}$\\
...
\includegraphics[scale=0.45]{volap5.eps} 

\emul

\item La surface d'une sphère de rayon $r$ est définie par la formule suivante : $A = 4\pi r^{2  }$\\

\textbf{Exemple :} La surface d'une sphère de rayon 2cm est :
\bmul{2}
$A = 4\pi r^{2}$\\
$A = 4\pi \times 2^{2}$\\
$A \approx 25 cm^{2}$
...
\columnbreak
\includegraphics[scale=0.45]{volap4.eps} 
\emul
...
\q Vérifier que les 2 conteneurs ont pratiquement le même volume. \\
...
\bmul{2}
\noindent \qa	Calculer le diamètre d'une balle.\\
\qa	Calculer le volume V1 de la boîte.\\
\qa 	Calculer le volume V2 des 3 balles. En donner la valeur exacte, puis 
l'arrondi au $mm^{3}$.\\
\qa	Calculer le pourcentage, arrondi à l'unité, du volume de la boîte occupé par les balles.\\

\columnbreak

\begin{center}
\includegraphics[scale=0.8]{volap1.eps} 
\end{center}
