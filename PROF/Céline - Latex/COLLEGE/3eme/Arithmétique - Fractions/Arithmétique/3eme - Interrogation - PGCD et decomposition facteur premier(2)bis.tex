...
\exo{1.5} On donne $2646 = 2 \times 3^{3} \times 7^{2}$. A l'aide de la décomposition en produit de facteurs premiers, citer les diviseurs de  2 646 parmi les nombres ci-dessous :\\

$2^{2} \times 3^{2}$ \hspace*{1cm} $2 \times 3^{2}$ \hspace*{1cm} $2 \times 7^{2}$ \hspace*{1cm} $21$ \hspace*{1cm} $49$\hspace*{1cm} $16$\hspace*{1cm} $9$ \hspace*{1cm} $42$\\
\reponse[3]\\


\exo{1.5} Calculer le PGCD de 220 et 126.\\
\reponse[10]\\
...
Pour son anniversaire, Ninon a acheté 2 280 carambars et 840 malabars. Elle veut faire des sachets pour ses amis.  Tous  les sachets  doivent  avoir  la  même composition  et  elle  doit  utiliser  tous  les  carambars  et  les 
malabars.\\

\initq \q Peut-elle faire 19 sachets? Si oui, quelle sera la composition de chaque sachet ?\\
\reponse[4]\\
