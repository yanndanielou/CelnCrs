...
\textbf{EXERCICES sur les fonctions linéaires}\\
\end{large}
\end{center}
\vspace*{0.5cm}

\textbf{EXERCICE 1 :} Les fonctions suivantes sont-elles linéaires ? Si oui, précisez leur coefficient.
...
\textbf{EXERCICE 2 :} Durant les soldes, un magasin pratique une remise de 35 $\%$ sur tous les articles.\\
...
\vspace*{0.5cm}
\textbf{EXERCICE 3 :} Tracer la représentation graphique de chaque fonction dans les repères suivants :

\begin{center}
\includegraphics[scale=1]{graphinterro.eps} 
\end{center}
