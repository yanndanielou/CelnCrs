...
\hline 
 & \hspace*{0.1cm} B \hspace*{0.1cm}& \hspace*{0.1cm} D \hspace*{0.1cm} & \hspace*{0.1cm} [AE] \hspace*{0.1cm} & $ \widehat{DCB}$ \\ 
\hline 
...
\q Quelle est la longueur du segment [PK] ? Justifier votre réponse.\\
...
\includegraphics[scale=0.9]{centresym.eps} \includegraphics[scale=1.2]{centresym2.eps} \includegraphics[scale=1.1]{centresym3.eps} 
