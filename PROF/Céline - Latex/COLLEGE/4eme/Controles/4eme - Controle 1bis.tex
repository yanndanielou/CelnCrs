...
\qa Un parallélogramme peut avoir un angle de 34 degré et un angle de 56 degré.\\

\qa Si CODE est un parallélogramme, alors CE = OD.\\

\qa Si LYNX est un parallélogramme de centre O, alors les triangles LYO et NOX ont le même périmètre.\\
...
\qa 5 \hspace*{0.5cm} 4 \hspace*{0.5cm} 3 \hspace*{0.5cm} 2 \hspace*{0.5cm} 1 = 2\\

\qa 5 \hspace*{0.5cm} 4 \hspace*{0.5cm} 3 \hspace*{0.5cm} 2 \hspace*{0.5cm} 1 = 4\\
