...
$B = (\dfrac{1}{2} - \dfrac{1}{3}) \div \dfrac{2}{3} +1$
\emul
...
\begin{center}
$D = \dfrac{3 \times 10^{2} \times 5 \times 10^{4}}{12 \times (10^{3})^{3}}$\\
\end{center}

\exo{4 } Soit l'expression $E= (3x-5)^{2} - (2x+1)^{2}$\\
...
Pour ce faire, on envisage d'insérer l'instruction \includegraphics[scale=0.8]{dmbrevet1cinq.eps}  dans le programme utilisé à la question 1. \\
